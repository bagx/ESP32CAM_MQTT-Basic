...
Podrás observar una cuenta progresiva, la cual envía el programa base del ESP32CAM. Puedes controlar el led flash del ESP32CAM con el switch del dashboard.

Por: [Brenda Gómez ](https://github.com/bagx)
